...
export default function CreateExamPage() {
    ...
    const availableSubjects = subjects.filter(subject => {
        ...
        const classMatch = String(subject.classId) === String(examData.classId);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
                <Link href="/admin/exams" className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
