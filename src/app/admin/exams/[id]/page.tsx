...
export default function ExamLobbyPage() {
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
                ...
                <Link href="/admin/exams" className="px-6 py-3 bg-slate-100 dark:bg-slate-800 rounded-xl font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                    Return to Exams
                </Link>
            </div>
        );
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            <Link href="/admin/exams" className="inline-flex items-center gap-2 text-slate-500 hover:text-blue-600 transition-colors font-medium">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[40px] p-8 md:p-12 border border-slate-200/60 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden relative">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col gap-4">
                        <Link
                            href={`/admin/exams/${currentExam.id}/take`}
