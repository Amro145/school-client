...
export default function Error({
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background text-foreground">
            ...
            >
                <div className="glass rounded-3xl p-8 md:p-12 shadow-2xl border border-(--border) text-center relative overflow-hidden group">

                    {/* Decorative top accent */}
                    <div className="absolute top-0 left-0 w-full h-2 bg-linear-to-r from-red-500 via-orange-500 to-red-500" />
                    ...
                    {error.digest && (
                        <p className="text-xs text-(--muted-foreground) mb-6 font-mono bg-(--muted) py-2 px-4 rounded-lg inline-block">
                    ...
                    >
                        <button
                            onClick={reset}
                            className="flex items-center justify-center px-6 py-4 bg-foreground text-background rounded-xl font-bold hover:opacity-90 transition-all transform active:scale-95 shadow-lg group-hover:shadow-xl"
                        >
